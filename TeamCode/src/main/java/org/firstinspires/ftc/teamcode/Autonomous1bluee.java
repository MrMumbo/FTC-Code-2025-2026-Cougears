...
@Autonomous(name="Robot: ShootDriveAutoBlue", group="Robot")
public class Autonomous1bluee extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        double drivepowerRight = 275.0;
        double drivepowerLeft = 250.0;
